...
export default function Welcome({ auth, laravelVersion, phpVersion, images }) {
    return (
        <>
            <Head title='Welcome' />
            <div className="bg-gradient-to-t to-violet-900 from-violet-1000 h-96">
            ...
            <div className='bg-gradient-to-t to-violet-1000 from-violet-1000 flex flex-row flex-wrap gap-[20px] justify-center'>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black bg-violet-1000 dark:text-white/50 h-full pl-auto pr-auto flex flex-col justify-start items-center p-[100px]">
                <div className='w-full flex flex-row gap-5 justify-center flex-wrap'>
                    {Array.from({ length: 10 }, (_, i) => (
                        <div className="max-w-xs bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-violet-950 dark:border-gray-700 scale-80">
                            <a href="#">
                                <img className="rounded-t-lg" src={images} alt="Image" />
                            </a>
                            <div className="p-5">
                                <a href="#">
                                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-black-500 dark:text-white">Noteworthy technology acquisitions 2021</h5>
                                </a>
            ...
            <footer className="bg-white dark:bg-black-800">
