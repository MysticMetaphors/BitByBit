export default function About() {
    return (
        <>
            ...
            <div className="bg-gray-50 relative text-black/50 dark:bg-black bg-violet-1000 dark:text-white/50 h-[50vh] flex flex-row flex-wrap justify-start items-center pb-[100px] ">
