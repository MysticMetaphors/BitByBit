export default function Creators() {
    return (
        <>
            ...
            <div className="bg-gray-50 relative text-black/50 dark:bg-black bg-violet-1000 dark:text-white/50 h-full flex flex-row flex-wrap justify-start items-center pb-[100px]">
                <div className='w-full flex flex-row gap-5 justify-center flex-wrap'>
                    {Array.from({ length: 12 }, (_, i) => (
                        <a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-violet-950 dark:hover:bg-violet-900">
                            <img class="object-cover w-full rounded-t-lg h-full md:h-full md:w-48 md:rounded-none md:rounded-s-lg" src="storage/Pixel Art background Violet theme nature (1).jpg" alt="" />
